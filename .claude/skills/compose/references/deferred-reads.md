...
Typical Frameport hotspots — live-view frame delivery animation, LazyColumn gallery/import screens (GalleryScreen, ImportScreen), connection-state transition animations — are all candidates for the patterns below.
