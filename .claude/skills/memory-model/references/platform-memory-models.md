...
| **ARM64** | **Weakly ordered** | **All barriers explicit** | **Frameport target; most permissive reordering** |
| POWER | Weakly ordered | Even weaker than ARM in some cases | |
| RISC-V | RVWMO | Defined per-instruction | |

ARM64 implications for Frameport:
...
Use case: when correctness depends on multiple atomics being observed in a consistent global order. Rare in Frameport — currently only used in test assertions.
