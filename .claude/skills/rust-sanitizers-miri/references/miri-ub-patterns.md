...
**Critical for Frameport**: Miri cannot execute JNI calls, libc FFI, or inline assembly. The JNI interop crate (`fuji-ffi`) and any crate calling libc syscalls directly must stub out FFI for Miri.
